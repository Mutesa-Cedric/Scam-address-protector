...
(function() {
    ...
    var objOptionAddHighlight = document.querySelector('[name="ext-smartaddressprotection-show_style"]');
    ...
    var objOptionBlockchainExplorer = document.getElementById('ext-smartaddressprotection-choose_blockchain');
    ...
    var objAddressLookups = document.getElementById('ext-smartaddressprotection-perform_address_lookups');
    ...
    let objBlacklistDomains = document.getElementById('ext-smartaddressprotection-blacklist_domains');
    ...
    objBlacklistDomains = document.getElementById('ext-smartaddressprotection-3rd_party_blacklist_domains');
    if (objBlacklistDomains) {
    ...
    var objBlacklistPunycodeDomains = document.getElementById('ext-smartaddressprotection-block_punycode_blacklist_domains');
    ...
    var objNetworkDetails = document.querySelector("#ext-smartaddressprotection-rpc_node_details > span");
    if(objNetworkDetails) {
        let objNetworkDetails;
        if(localStorage.getItem("ext-smartaddressprotection-rpc_node_details") === null) {
            objNetworkDetails = {
                "network_id": 1,
                "chain_id": 1,
                "name": "MAINNET",
            ...
            objNetworkDetails = JSON.parse(localStorage.getItem("ext-smartaddressprotection-rpc_node_details"));
        }
        document.querySelector("#ext-smartaddressprotection-rpc_node_details > span").innerText = [objNetworkDetails.name, objNetworkDetails.type].join(" - ");
    }
    ...
    function(request, sender, sendResponse) {
        ...
        switch(strOption) {
            case 'highlight_option' :
                strResponse = localStorage.getItem("ext-smartaddressprotection-show_style");
                break;
            case 'blockchain_explorer' :
                strResponse = localStorage.getItem("ext-smartaddressprotection-blockchain_explorer");
                if(strResponse === null) {
            ...
            case 'blacklist_domains' :
                ...
                if(localStorage.getItem("ext-smartaddressprotection-blacklist_domains") === null) {
                    strResponse = 1;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-blacklist_domains");
                }
                break;
            case '3rd_party_blacklist_domains' :
                //This option is enabled by defailt
                if(localStorage.getItem("ext-smartaddressprotection-3rd_party_blacklist_domains") === null) {
                    strResponse = 1;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-3rd_party_blacklist_domains");
                }
                break;
            ...
            case 'use_3rd_party_blacklists' :
                //This option is enabled by default
                if(localStorage.getItem("ext-smartaddressprotection-use_3rd_party_blacklist") === null) {
                    strResponse = 1;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-use_3rd_party_blacklist");
                }
                break;
            case 'block_punycode_domains' :
                //This option is disabled by default
                if(localStorage.getItem("ext-smartaddressprotection-block_punycode_blacklist_domains") === null) {
                    strResponse = 0;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-block_punycode_blacklist_domains");
                }
                break;
            ...
            case 'rpc_details' :
                    if(localStorage.getItem("ext-smartaddressprotection-rpc_node_details") === null) {
                        ...
                        strResponse = localStorage.getItem("ext-smartaddressprotection-rpc_node_details");
                    }
                break;
            case 'rpc_provider' :
                    if(localStorage.getItem("ext-smartaddressprotection-rpc_node") === null) {
                        strResponse = "https://mainnet.infura.io/v3/02b145caa61b49998168f2b97d4ef323";
                    } else {
                        strResponse = localStorage.getItem("ext-smartaddressprotection-rpc_node");
                    }
                break;
            ...
            case 'perform_address_lookups' :
                //This option is enabled by default
                if(localStorage.getItem("ext-smartaddressprotection-perform_address_lookups") === null) {
                    strResponse = 1;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-perform_address_lookups");
                }
                break;
            ...
            case 'twitter_validation' :
                //This option is enabled by default
                if(localStorage.getItem("ext-smartaddressprotection-twitter_validation") === null) {
                    strResponse = 1;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-twitter_validation");
                }
                break;
            case 'twitter_lists' :
                ...
                if(localStorage.getItem("ext-smartaddressprotection-twitter_lists")) {
                    let saved_settings = JSON.parse(localStorage.getItem("ext-smartaddressprotection-twitter_lists"));
                ...
                if((Math.floor(Date.now() - twitter_lists.last_fetched)) > 600*1000) {
                    ...
                    .then((lists) => {
                        ...
                        localStorage.setItem("ext-smartaddressprotection-twitter_lists", JSON.stringify(twitter_lists));
                    });
                }

                if(localStorage.getItem("ext-smartaddressprotection-twitter_lists")) {
                    var cached_list = JSON.parse(localStorage.getItem("ext-smartaddressprotection-twitter_lists"));
            ...
            case 'signature_inject' :
                //This option is enabled by default
                if(localStorage.getItem("ext-smartaddressprotection-signature_inject") === null) {
                    strResponse = 1;
                } else {
                    strResponse = localStorage.getItem("ext-smartaddressprotection-signature_inject");
                }
                break;
            case 'user_domain_bookmarks' :
                // Fetches the user domain bookmarks - these are domains they trust
                var strBookmarks = localStorage.getItem("ext-smartaddressprotection-bookmarks");
                ...
                switch(request.icon) {
                    case 'whitelisted' :
                        ...
                        chrome.browserAction.setTitle({
                            title: ["This domain is recognised as legitimate by ScamAddressProtection\", strReason].filter(i => i).join(" - ")
                        });
                    break;
                    case 'blacklisted' :
                        chrome.browserAction.setIcon({
                        ...
                        chrome.browserAction.setTitle({
                            title: ["This domain is recognised as bad by ScamAddressProtection\", strReason].filter(i => i).join(" - ")
                        });
                    break;                    
                    case 'neutral' :
                    default :
...
function getBlacklistedDomains(strType)
{
    var objEalBlacklistedDomains = {
        "eal": {
            ...
            "domains": [],
            "format": "plain",
            "repo": "https://raw.githubusercontent.com/409H/ScamAddressProtection\/master/blacklists/domains.json",
            "identifer": "eal"
        },
        "uri": {
            "timestamp": 0,
            "domains": [],
            "format": "plain",
            "repo": "https://raw.githubusercontent.com/409H/ScamAddressProtection\/master/blacklists/uri.json",
            "identifer": "uri"
        },
        "third_party": {
            "phishfort": {
    ...
    if (localStorage.getItem("ext-smartaddressprotection-blacklist_domains_list") === null) {
        updateAllBlacklists(objEalBlacklistedDomains);
    } else {
        var objBlacklistedDomains = localStorage.getItem("ext-smartaddressprotection-blacklist_domains_list");
    ...
    return localStorage.getItem(`ext-smartaddressprotection-${strType}blacklist_domains_list`);
}
...
function updateAllBlacklists(objEalBlacklistedDomains)
{
    getBlacklistedDomainsFromSource(objEalBlacklistedDomains.eal).then(function (arrDomains) {
        ...
        localStorage.setItem("ext-smartaddressprotection-blacklist_domains_list", JSON.stringify(objEalBlacklistedDomains.eal));
    });
    ...
    getBlacklistedDomainsFromSource(objEalBlacklistedDomains.uri).then(function (arrDomains) {
        ...
        localStorage.setItem("ext-smartaddressprotection-uri_blacklist_domains_list", JSON.stringify(objEalBlacklistedDomains.uri));
    });

    if( [null, 1].indexOf(localStorage.getItem("ext-smartaddressprotection-use_3rd_party_blacklist")) >= 0) {
        getBlacklistedDomainsFromSource(objEalBlacklistedDomains.third_party.phishfort).then(function (arrDomains) {
            ...
            let objEalBlacklist = localStorage.getItem("ext-smartaddressprotection-blacklist_domains_list");
            ...
            localStorage.setItem("ext-smartaddressprotection-3p_blacklist_domains_list", JSON.stringify(objEalBlacklistedDomains.third_party));
...
function getWhitelistedDomains()
{
    ...
    //See if we need to get the blacklisted domains - ie: do we have them cached?
    if (localStorage.getItem("ext-smartaddressprotection-whitelist_domains_list") === null) {
        getWhitelistedDomainsFromSource().then(function (arrDomains) {
            ...
            localStorage.setItem("ext-smartaddressprotection-whitelist_domains_list", JSON.stringify(objWhitelistedDomains));
            return objWhitelistedDomains.domains;
        });
    } else {
        objWhitelistedDomains = localStorage.getItem("ext-smartaddressprotection-whitelist_domains_list");
        //Check to see if the cache is older than 5 minutes, if so re-cache it.
...
{
    try {
        console.log("Getting whitelist from GitHub now: https://raw.githubusercontent.com/409H/ScamAddressProtection\/master/whitelists/domains.json");
        let objResponse = await fetch("https://raw.githubusercontent.com/409H/ScamAddressProtection\/master/whitelists/domains.json");
        return objResponse.json();
    }
    catch(objError) {
        console.log("Failed to get whitelist for https://raw.githubusercontent.com/409H/ScamAddressProtection\/master/whitelists/domains.json", objError);
    }
}
