...
(function (root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    var bsn = factory();
    root.ext_smartaddressprotection_Popover =
      bsn.ext_smartaddressprotection_Popover;
    root.ext_smartaddressprotection_Tab = bsn.ext_smartaddressprotection_Tab;
  }
})(this, function () {
  ...
  var globalObject = typeof global !== "undefined" ? global : this || window,
    ...
    // components
    stringPopover = "ext_smartaddressprotection_Popover",
    stringTab = "ext_smartaddressprotection_Tab",
    // options DATA API
    ...
    styleTip = function (link, element, position, parent) {
      ...
      if (position === left || position === right) {
        ...
        if (halfTopExceed) {
          ...
          arrowTop =
            elementDimensions.h - linkDimensions.h / 2 - arrowWidth / 2;
        } else {
          topPosition =
            rect[top] +
            scroll.y -
      ...
      topPosition =
        position === top && isPopover ? topPosition - arrowWidth : topPosition;
      leftPosition =
        position === left && isPopover
          ? leftPosition - arrowWidth
          : leftPosition;
  ...
  // POPOVER DEFINITION
  // ==================
  var ext_smartaddressprotection_Popover = function (element, options) {
    ...
    var triggerData = element[getAttribute](dataTrigger), // click / hover / focus
      ...
      // internal strings
      component = "ext-smartaddressprotection-popover",
      template = "template",
      trigger = "trigger",
      classString = "class",
      div = "div",
    ...
    this[container] = queryElement(options[container])
      ? queryElement(options[container])
      : queryElement(containerData)
      ? queryElement(containerData)
      : navbarFixedTop
      ? navbarFixedTop
      : navbarFixedBottom
  ...
  initializeDataAPI(
    stringPopover,
    ext_smartaddressprotection_Popover,
    DOC[querySelectorAll](
      "[" + dataToggle + '="ext-smartaddressprotection-popover"]'
    )
  );
  ...
  // TAB DEFINITION
  // ==============
  var ext_smartaddressprotection_Tab = function (element, options) {
    // initialization element
    element = queryElement(element);
    ...
    var heightData = element[getAttribute](dataHeight),
      // strings
      component = "ext-smartaddressprotection-tab",
      height = "height",
      float = "float",
    ...
    var self = this,
      next,
      tabs = getClosest(element, ".ext-smartaddressprotection-nav"),
    ...
    var getActiveTab = function () {
      ...
      clickHandler = function (e) {
        ...
        next =
          ...
          targetsReg.test(e[target][getAttribute]("href"))
            ? e[target]
  ...
  initializeDataAPI(
    stringTab,
    ext_smartaddressprotection_Tab,
    DOC[querySelectorAll](
      "[" + dataToggle + '="ext-smartaddressprotection-tab"]'
    )
  );

  return {
    ext_smartaddressprotection_Popover: ext_smartaddressprotection_Popover,
    ext_smartaddressprotection_Tab: ext_smartaddressprotection_Tab,
  };
});
