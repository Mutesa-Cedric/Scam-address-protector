...
function togglePerformAddressLookups() {
  var objAddressLookups = document.getElementById(
    "ext-smartaddressprotection-perform_address_lookups"
  );
...
function refreshPerformAddressLookups() {
  var intAddressLookups = localStorage.getItem(
    "ext-smartaddressprotection-perform_address_lookups"
  );
  ...
  document.getElementById(
    "ext-smartaddressprotection-perform_address_lookups"
  ).checked = intAddressLookups == 1 ? true : false;
}
